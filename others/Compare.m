...
% d3= load('displacement-damaged (20%).txt');
% d4= load('displacement-damaged (40%).txt');
v1= load('Velocity-E(0%).txt');
v2= load('Velocity-E(20%).txt');
% v3= load('velocity-damaged (20%).txt');
% v4= load('velocity-damaged (40%).txt');
ac1= load('Acceleration-E(0%).txt');
ac2= load('Acceleration-E(20%).txt');
% ac3= load('Acceleration-damaged (20%).txt');
% ac4= load('Acceleration-damaged (40%).txt');
fig=figure (1);
